...
void Filters::convolution( const Convolution &params, const ImageDataBase &in, ImageDataBase &out )
{
    ...
    {
    case Border::extend:
        extend( input, params.kernel.w(), params.kernel.h() );
        break;
    case Border::wrap:
        wrap( input, params.kernel.w(), params.kernel.h() );
        break;
    case Border::mirror:
        mirror( input, params.kernel.w(), params.kernel.h() );
        break;
    case Border::cropKernel:
        constant( input, params.kernel.w(), params.kernel.h(), B4() );
        break;
    case Border::constant:
        constant( input, params.kernel.w(), params.kernel.h(), params.constant );
        break;
    case Border::crop:
        break;
    default:
