...
1. Download boost from https://www.boost.org/users/history/version_1_82_0.html 
1. Place boost folder next to Image repository folder, rename it to Boost-1.82.0
...
2. Open Code::Blocks, Settings/Compiler.../Toolchain executables/Auto-detect (Auto-detect works, if MinGW folder is on disk C:\\)
2. Close Code::Blocks
