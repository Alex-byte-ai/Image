...
public:
    ...
    void rectangle( int x0, int y0, int w, int h, Pixel p ) override;
    void line( int x0, int y0, int x1, int y1, Pixel p ) override;
    void circle( int x0, int y0, int r, Pixel p ) override;
    void ellipse( int x0, int y0, int rx, int ry, Pixel p ) override;
